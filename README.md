...
приложений кешируются локально. Следующий этап — статистика и API; dashboard
и автозапуск появятся на этапе UI и сборки.
...
FastAPI будет добавлен на следующем этапе.
